        ...
        <Card className='rounded-top-0 rounded-bottom-2 border-top-0'>
            <Card.Footer className='p-0 border-top-0'>
                <div className='my-2 mx-3 d-flex justify-content-between align-items-center'>
                    <div className='d-flex gap-lg-4 gap-lg-2 gap-1'>
                        ...
                        <div className='vr d-lg-block d-none' />
                        <div className='d-none d-sm-flex gap-lg-2 gap-1'>
                            <TooltipOverlay
                        ...
                        <div className='vr d-lg-block d-none' />
                        <div className='d-none d-md-flex gap-lg-2 gap-1'>
                            <TooltipOverlay
